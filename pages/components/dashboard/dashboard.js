											...
											<div className="row align-items-center">
												<div className="offset-xl-3 offset-sm-6 col-xl-8 col-sm-6 col-12 img-bg ">
													<h4 className="d-flex  mb-3">
														<span className="font-weight-bold text-white ">렙다이어리 관리자 페이지 입니다.</span>
													</h4>
													<p className="tx-white-7 mb-1">오늘의 렙다이어리 상황을 모니터링 하세요.
														신규 고객은 <b className="text-warning">400명</b>이 더 다운받앗습니다.</p>
												</div>
										...
										<div className="card-body">
											<div className="card-item">
												...
												<div className="card-item-title mb-2">
													<label className="main-content-label tx-13 font-weight-bold mb-1">광고수익</label>
													<span className="d-block tx-12 mb-0 text-muted">전월달 실적대비</span>
												</div>
												<div className="card-item-body">
													<div className="card-item-stat">
														<h4 className="font-weight-bold">$5,900.00</h4>
														<small><b className="text-success">55%</b> 증가</small>
													</div>
												</div>
											</div>
										</div>
									...
									<div className="card custom-card">
										<div className="card-body">
											<div className="card-item">
												...
												<div className="card-item-title mb-2">
													<label className="main-content-label tx-13 font-weight-bold mb-1">새로운 유저수</label>
													<span className="d-block tx-12 mb-0 text-muted">전월달 실적대비</span>
												</div>
												<div className="card-item-body">
													<div className="card-item-stat">
														<h4 className="font-weight-bold">1,204</h4>
														<small><b className="text-success">300명</b> 증가</small>
													</div>
												</div>
											</div>
										</div>
									...
									<div className="card custom-card">
										<div className="card-body">
											<div className="card-item">
												...
												<div className="card-item-title  mb-2">
													<label className="main-content-label tx-13 font-weight-bold mb-1">전체 유저수</label>
													<span className="d-block tx-12 mb-0 text-muted">전월 실적대비</span>
												</div>
												<div className="card-item-body">
													<div className="card-item-stat">
														<h4 className="font-weight-bold">34,509명</h4>
														<small><b className="text-danger">10명</b> 감소</small>
													</div>
												</div>
											</div>
										</div>
            ...
            {/* <!-- col end --> */}
						...
						<div className="col-sm-12 col-lg-12 col-xl-4 mt-xl-4">
							<div className="card custom-card card-dashboard-calendar pb-0">
								<label className="main-content-label mb-2 pt-1">광고 업체 순위</label>
								<span className="d-block tx-12 mb-2 text-muted">광고 업체 클릭 및 조회수 순위 입니다.</span>
									...
									<tbody>
											...
											<td>
												<div className="d-flex align-middle ms-3">
													<div className="d-inline-block">
														<h6 className="mb-1">사료나라</h6>
														<p className="mb-0 tx-13 text-muted">먹이</p>
													</div>
												</div>
											</td>
										...
										<tr>
											...
											<td>
												<div className="d-flex align-middle ms-3">
													<div className="d-inline-block">
														<h6 className="mb-1">게코호텔</h6>
														<p className="mb-0 tx-13 text-muted">호텔링</p>
													</div>
												</div>
											</td>
											<td className="text-end">
										...
										<tr>
											...
											<td>
												<div className="d-flex align-middle ms-3">
													<div className="d-inline-block">
														<h6 className="mb-1">귀뚜람 농장</h6>
														<p className="mb-0 tx-13 text-muted">사료</p>
													</div>
												</div>
											</td>
											<td className="text-end">
										...
										<tr>
											...
											<td>
												<div className="d-flex align-middle ms-3">
													<div className="d-inline-block">
														<h6 className="mb-1">특수동물병원</h6>
														<p className="mb-0 tx-13 text-muted">병원</p>
													</div>
												</div>
											</td>
											<td className="text-end">
										...
										<tr>
											...
											<td className="pb-0">
												<div className="d-flex align-middle ms-3">
													<div className="d-inline-block">
														<h6 className="mb-1">게코 세상</h6>
														<p className="mb-0 tx-13 text-muted">분양</p>
													</div>
												</div>
											</td>
									...
									<div className="row row-sm">
										<div className="col-6">
											<div className="card-item-title">
												<label className="main-content-label tx-13 font-weight-bold mb-2">오늘 방문자수</label>
												<span className="d-block tx-12 mb-0 text-muted">오늘의 렙다이어리 어플 방문자 수</span>
											</div>
											<p className="mb-0 tx-24 mt-2"><b className="text-primary">1,203명</b></p>
											<a href="#!" className="text-muted">2023년 12월 5일 </a>
										</div>
										<div className="col-6">
